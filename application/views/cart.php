...
<?php if($this->cart->contents()) : ?>
    <form method="post" action="cart/process">
        ...
        <tr>
            <th>Quantity</th>
            <th>Item Title</th>
            <th style="text-align:right">Item Prices</th>
        </tr>
        ...
        <tr>
            ...
            <td class="right" style="text-align:right"><strong>$<?php echo $this->cart->format_number($this->cart->total() + $this->config->item('tax'));?></td>
        </tr>
